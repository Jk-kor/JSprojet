...
// Middleware pour charger les utilisateurs
function loadUsers() {
    try {
...
// Middleware pour sauvegarder les utilisateurs
...
// Middleware pour passer userId et isAdmin à toutes les vues
...
app.post('/add-listing', upload.array('photos', 5), (req, res) => {
    ...
    const newListing = {
        ...
        id: newId,
        name: req.body.name,
        photos: photos.length ? photos : ['default.jpg'],
